...
export default function ModernResume({ data }: { data: ResumeData }) {
  ...
  return (
    <div data-resume-page className="w-full max-w-[800px] mx-auto bg-white shadow-lg min-h-[1056px] flex font-sans text-gray-800" style={{ color: data.theme?.bodyText || undefined, fontFamily: cssFontStack(data.theme?.fontFamily) || undefined }}>
      {/* Left Column */}
